...
namespace ETModel
{
    public class Skill : Entity
    {
        ...
        public TribeType TribeType { get; set; } = TribeType.Case;          //作用类型，表示作用在那个属性之上
