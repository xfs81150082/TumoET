...
namespace ETModel
{
    ...
    public partial class Booker_PatrolMap : pb::IMessage
    {
        private static readonly pb::MessageParser<Booker_PatrolMap> _parser = new pb::MessageParser<Booker_PatrolMap>(() => (Booker_PatrolMap)MessagePool.Instance.Fetch(typeof(Booker_PatrolMap)));
        public static pb::MessageParser<Booker_PatrolMap> Parser { get { return _parser; } }
