...
namespace ETHotfix {
    ...
    /// </summary>
    #region
    public partial class C2M_RaycastHitActorRequest : pb::IMessage
    {
        private static readonly pb::MessageParser<C2M_RaycastHitActorRequest> _parser = new pb::MessageParser<C2M_RaycastHitActorRequest>(() => (C2M_RaycastHitActorRequest)MessagePool.Instance.Fetch(typeof(C2M_RaycastHitActorRequest)));
        public static pb::MessageParser<C2M_RaycastHitActorRequest> Parser { get { return _parser; } }
    ...
    public partial class M2C_RaycastHitActorResponse : pb::IMessage
    {
        private static readonly pb::MessageParser<M2C_RaycastHitActorResponse> _parser = new pb::MessageParser<M2C_RaycastHitActorResponse>(() => (M2C_RaycastHitActorResponse)MessagePool.Instance.Fetch(typeof(M2C_RaycastHitActorResponse)));
        public static pb::MessageParser<M2C_RaycastHitActorResponse> Parser { get { return _parser; } }
